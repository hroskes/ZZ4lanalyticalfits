...
//#include "/afs/cern.ch/user/u/usarica/work/snowmass2013/src/RooSpinZero_7DComplex_withAccep_withFepspr.cc"
//#include "/home/usarical/work/snowmass2013/src/RooSpinZero_7DComplex_withAccep_withFepspr.h"
...
class ScalarPdfFactory_withFepspr{

public:

  RooSpinZero_7DComplex_withAccep_withFepspr::measurables _measurables;
  RooSpinZero_7DComplex_withAccep_withFepspr::modelParameters _modelParams;
  RooSpinZero_7DComplex_withAccep_withFepspr::accepParameters _accepParams;
  ...
  */
  ...
  //RooSpinZero_7DComplex_withAccep_withFepspr* PDFangleAccep;
  RooSpinZero_7DComplex_withAccep_withFepspr* PDF;
  ...
  ScalarPdfFactory_withFepspr(RooRealVar* m1,RooRealVar* m2,RooRealVar* hs,RooRealVar* h1,RooRealVar* h2,RooRealVar* Phi,RooRealVar* Phi1,RooRealVar* mZZ, int para, bool acceptance, bool pmf_applied=false, double myPOLE=125.6) {
    ...
    _modelParams.mPOLE = new RooRealVar("mPOLE","mPOLE",myPOLE);
	...
	if(!pmf_applied) _modelParams.fepspr = new RooRealVar("fepspr","#epsilon",0.,0.,1.0);
	else _modelParams.fepspr = new RooRealVar("fepspr","#epsilon",0.,-1.0,1.0);
    ...
    PDF = new RooSpinZero_7DComplex_withAccep_withFepspr("PDF","PDF",
					      _measurables,
					      _modelParams,
					      _accepParams);
    ...
    //std::cout << "ScalarPdfFactory_withFepspr::ScalarPdfFactory_withFepspr - done " << std::endl;

  };

  ~ScalarPdfFactory_withFepspr(){

    //std::cout << "~ScalarPdfFactory_withFepspr" << std::endl;
    ...
    //std::cout << "~ScalarPdfFactory_withFepspr - end " << std::endl;

  };

  void makeSMHiggs(){

    //std::cout << "ScalarPdfFactory_withFepspr::makeSMHiggs()" << std::endl;

    _modelParams.parameterization=1;

    _modelParams.fepspr->setVal(0.0);
  ...
  void makeLGHiggs(){          
    ...
    //std::cout << "ScalarPdfFactory_withFepspr::makeLGHiggs()" << std::endl;
  ...
  void makePSHiggs(){
    ...
    //std::cout << "ScalarPdfFactory_withFepspr::makePSHiggs()" << std::endl;
  ...
  void makeCustom(double a1, double a2, double a3,
    ...
    //std::cout << "ScalarPdfFactory_withFepspr::makeCustom()" << std::endl;
  ...
  void makeParamsConst(bool yesNo=true){
    ...
    //std::cout << "ScalarPdfFactory_withFepspr::makeParamsConst()" << std::endl;
    ...
    if(yesNo){
      ...
      _modelParams.fepspr->setConstant(kTRUE);
